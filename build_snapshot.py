...
def _build_vocabulary():
    ...
    terms = [
        ...
        {"key": "production_lake", "label": "Production lake", "group": "Data pipeline",
         "what": "Governed public assets in the snapshot ledger. These are the datasets the site can describe and download safely.",
        ...
        {"key": "mission_control_snapshot", "label": "Mission Control snapshot", "group": "Ops & public site",
         "what": "The static public site built from one frozen data.json so findings, models, map layers, downloads, and glossary cannot drift apart.",
         "examples": ["mbal-mission-control-live/index.html", "data.json", "downloads.json", "GitHub Pages"]},
        ...
        {"key": "download_fingerprint", "label": "Download fingerprint", "group": "Ops & public site",
         "what": "A checksum that lets a reader verify a downloaded artifact is exactly the published snapshot.",
         "examples": ["sha256", "downloads.json", "shasum -a 256", "frozen snapshot"]},
